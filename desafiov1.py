...
class Historico:
    ...
    def transacoes_do_dia(self):
        ...
        return [t for t in self.transacoes if t["data"].startswith(data_atual)]
...
class Cliente:
    ...
    def realizar_transacao(self, conta, transacao):
        # Verifica o número de transações no dia
        transacoes_do_dia = conta.historico.transacoes_do_dia()
        
        if len(transacoes_do_dia) >= 10:
            print("\n@@@ Você excedeu o número de transações permitidas para hoje! @@@")
            return

        # Se o limite não foi atingido, registra a transação
